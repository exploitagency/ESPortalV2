...
const char SITE4_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="orange" text="white">
<center><h1>
...
const char SITE5_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="blue" text="white">
<center><h1>
...
/*
const char SITE6_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="purple" text="white">
<center><h1>
...
const char SITE7_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="orange" text="white">
<center><h1>
...
const char SITE8_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="blue" text="white">
<center><h1>
...
const char SITE9_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="purple" text="white">
<center><h1>
...
const char SITE10_HTML[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<body bgcolor="purple" text="white">
<center><h1>
